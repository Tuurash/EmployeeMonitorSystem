...
namespace EmployeeManagementSystem {
    ...
    public partial class EmployeeManagementSystemDataSet1 : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public EmployeeRow AddEmployeeRow(string Name, string Email, string ContactNo, string JoiningDate, string Address) {
...
namespace EmployeeManagementSystem.EmployeeManagementSystemDataSet1TableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Employee] WHERE (([EmpID] = @Original_EmpID) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_ContactNo = 1 AND [ContactNo] IS NULL) OR ([ContactNo] = @Original_ContactNo)) AND ((@IsNull_JoiningDate = 1 AND [JoiningDate] IS NULL) OR ([JoiningDate] = @Original_JoiningDate)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employee] ([Name], [Email], [ContactNo], [JoiningDate], [Addre" +
                "ss]) VALUES (@Name, @Email, @ContactNo, @JoiningDate, @Address);\r\nSELECT EmpID, " +
                "Name, Email, ContactNo, JoiningDate, Address FROM Employee WHERE (EmpID = SCOPE_" +
                "IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [Name] = @Name, [Email] = @Email, [ContactNo] = @ContactNo, [JoiningDate] = @JoiningDate, [Address] = @Address WHERE (([EmpID] = @Original_EmpID) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_ContactNo = 1 AND [ContactNo] IS NULL) OR ([ContactNo] = @Original_ContactNo)) AND ((@IsNull_JoiningDate = 1 AND [JoiningDate] IS NULL) OR ([JoiningDate] = @Original_JoiningDate)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)));
SELECT EmpID, Name, Email, ContactNo, JoiningDate, Address FROM Employee WHERE (EmpID = @EmpID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmpID, Name, Email, ContactNo, JoiningDate, Address FROM dbo.Employee";
        ...
        public virtual int Fill(EmployeeManagementSystemDataSet1.EmployeeDataTable dataTable) {
        ...
        public virtual EmployeeManagementSystemDataSet1.EmployeeDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            EmployeeManagementSystemDataSet1.EmployeeDataTable dataTable = new EmployeeManagementSystemDataSet1.EmployeeDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(EmployeeManagementSystemDataSet1.EmployeeDataTable dataTable) {
        ...
        public virtual int Delete(int Original_EmpID, string Original_Name, string Original_Email, string Original_ContactNo, string Original_JoiningDate, string Original_Address) {
        ...
        public virtual int Insert(string Name, string Email, string ContactNo, string JoiningDate, string Address) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Email, string ContactNo, string JoiningDate, string Address, int Original_EmpID, string Original_Name, string Original_Email, string Original_ContactNo, string Original_JoiningDate, string Original_Address, int EmpID) {
            if ((Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Email, string ContactNo, string JoiningDate, string Address, int Original_EmpID, string Original_Name, string Original_Email, string Original_ContactNo, string Original_JoiningDate, string Original_Address) {
            return this.Update(Name, Email, ContactNo, JoiningDate, Address, Original_EmpID, Original_Name, Original_Email, Original_ContactNo, Original_JoiningDate, Original_Address, Original_EmpID);
        }
    }
